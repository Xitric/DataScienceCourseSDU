...
docker run --rm --ip 172.200.0.6 --hostname importer6 --name importer6 -v mysql:/var/lib/mysql -t -d debian:9
...
docker cp %dir%/sfdb/mysql importer6:var/lib/
